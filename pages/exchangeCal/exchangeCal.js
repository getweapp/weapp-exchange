...
Page({
    ...
    fetchRate:function(){
        ...
        if(self.data.date && self.data.debitCurrency && self.data.tradeCurrency){
            wx.request({
                url: 'https://api.getweapp.com/thirdparty/95516/web.exchange.rate?date='+ self.data.date +'&baseCurrency='+ self.data.debitCurrency.description +'&transactionCurrency='+ self.data.tradeCurrency.description,
                header:{
